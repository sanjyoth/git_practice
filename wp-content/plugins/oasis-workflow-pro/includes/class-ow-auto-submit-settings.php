...
class OW_Auto_Submit_Settings {
   ...
   public function __construct() {
      ...
      $this->custom_intervals = array(
        'minutes_15'  => __( '15 Minutes', 'oasisworkflow' ),
        'minutes_30'  => __( '30 Minutes', 'oasisworkflow' ),
        'minutes_45'  => __( '45 Minutes', 'oasisworkflow' ),
        'hourly'      => __( '1 Hour', 'oasisworkflow' ),
        'hours_4'     => __( '4 Hours', 'oasisworkflow' ),
        'hours_8'     => __( '8 Hours', 'oasisworkflow')
      );
   }
               ...
               <div id="settingstuff">
                  <ol>
                     ...
                     <?php if ( $this->custom_intervals ) : ?>
                        <?php foreach ( $this->custom_intervals as $interval => $display_value ) : ?>
                           <?php $is_default = $auto_submit_interval == $interval ? 'selected' : ''; ?>
                                 <option value="<?php echo $interval; ?>" <?php echo $is_default; ?>><?php echo $display_value; ?></option>
                        <?php endforeach; ?>
                     <?php endif; ?>
                              </select>
                              <br/>
