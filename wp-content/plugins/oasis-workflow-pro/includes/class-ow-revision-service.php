...
//             	OW_Utility::instance()->logger( "adding to original");
   ...
   public function new_draft_link_row( $actions, $post ) {
      ...
      if ( ( $post_status == 'publish' || $post_status == 'future' || $post_status == 'private') &&
         ...
         $actions['edit_as_new_draft'] = "<a href='javascript:void(0);' class='ow-make-revision'
         	postid='$post->ID'
    ...
    * @return string comparison data with heading
    *
    * @since 3.4
    */
   public function compare_tags( $original_post_id, $revision_post_id, $ow_diff ) {
      ...
      $diff = $ow_diff->compare( implode( ", ", $original_tags ), implode( ", ", $revision_tags ) );
    ...
    * @param int $original_post_id
    * @param int $revision_post_id
    * @return string comparision data with heading
    *
    * @since 3.4
    * @since 3.8 included compare for custom categories as well
    */
   public function compare_categories( $original_post_id, $revision_post_id, $ow_diff ) {
      $data = '';
      ...
      $diff = $ow_diff->compare( $original_categories, $revise_categories );
    ...
    * @since 3.4
    */
   public function compare_featured_image( $original_post_id, $revision_post_id, $ow_diff ) {
      $data = '';
      ...
      $diff = $ow_diff->compare( $original_feature_image, $revision_feature_image );
