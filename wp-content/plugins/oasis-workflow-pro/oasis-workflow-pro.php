...
define( 'OASISWF_VERSION', '5.0' );
define( 'OASISWF_DB_VERSION', '5.0' );
...
//		disabled for now
//		add_action( 'admin_init', array( $this, 'validate_free_version_exists' ) );
	}
	...
	public function register_menu_pages() {
      ...
      if ( has_filter( 'ow_workflow_menu_position' ) ) {
		...
		if ( current_user_can( 'ow_export_import_workflow' ) ) {
			add_submenu_page( 'oasiswf-inbox',
					__( 'Import Workflows', 'oasisworkflow' ),
					__( 'Import Workflows', 'oasisworkflow' ),
					'ow_export_import_workflow',
					'oasiswf-import',
					array( $this, 'import_workflows_page_content' ) );
		}
   ...
   public function import_workflows_page_content() {
      include( OASISWF_PATH . "includes/pages/workflow-import.php" );
   }
   ...
   /**
	...
	public function load_all_classes() {
      ...
      if ( ! class_exists( 'OW_Workflow_Service' ) ) {
		...
		if ( ! class_exists( 'OW_Workflow_Export_Import' ) ) {
			include( OASISWF_PATH . 'includes/class-ow-workflow-export-import.php' );
		}
